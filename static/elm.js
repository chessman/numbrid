...
var author$project$Main$JargAlalutlev = {$: 'JargAlalutlev'};
var author$project$Main$Kuulamine = {$: 'Kuulamine'};
var author$project$Main$NavbarMsg = function (a) {
	return {$: 'NavbarMsg', a: a};
};
var author$project$Main$defaultQuiz = {jargAlalutlev: 'esimesel', jargNimetav: 'esimene', n: 1, pohiNimetav: 'üks'};
...
var author$project$Main$init = function (_n0) {
	...
	var navbarCmd = _n1.b;
	return _Utils_Tuple2(
		{gameType: author$project$Main$Kuulamine, loaded: true, navbarState: navbarState, numberType: author$project$Main$JargAlalutlev, quiz: author$project$Main$defaultQuiz, state: author$project$Main$Answer},
		navbarCmd);
};
var author$project$Main$KeyPressMsg = function (a) {
	return {$: 'KeyPressMsg', a: a};
};
var elm$json$Json$Decode$field = _Json_decodeField;
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Main$keyDecoder = A2(
	elm$json$Json$Decode$map,
	author$project$Main$KeyPressMsg,
...
var author$project$Main$GotQuizMsg = function (a) {
	return {$: 'GotQuizMsg', a: a};
};
var author$project$Main$Quiz = F4(
	function (n, pohiNimetav, jargNimetav, jargAlalutlev) {
		return {jargAlalutlev: jargAlalutlev, jargNimetav: jargNimetav, n: n, pohiNimetav: pohiNimetav};
	});
var elm$json$Json$Decode$map4 = _Json_map4;
var author$project$Main$quizDecoder = A5(
	elm$json$Json$Decode$map4,
	author$project$Main$Quiz,
	A2(elm$json$Json$Decode$field, 'N', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'QuantitiveNominative', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'OrdinalNominative', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'OrdinalAdessive', elm$json$Json$Decode$string));
...
var author$project$Main$getNumber = elm$http$Http$get(
	{
		expect: A2(elm$http$Http$expectJson, author$project$Main$GotQuizMsg, author$project$Main$quizDecoder),
		url: '/next'
	});
var author$project$Main$nextState = function (state) {
	if (state.$ === 'Question') {
		return author$project$Main$Answer;
	} else {
		return author$project$Main$Question;
	}
};
			...
			switch (msg.$) {
				case 'NextMsg':
					var newModel = _Utils_update(
						model,
						{
							state: author$project$Main$nextState(model.state)
						});
					return _Utils_eq(newModel.state, author$project$Main$Question) ? _Utils_Tuple2(
						_Utils_update(
							newModel,
							{loaded: false}),
						author$project$Main$getNumber) : _Utils_Tuple2(newModel, elm$core$Platform$Cmd$none);
				case 'SetupGameMsg':
					var gameType = msg.a;
					var numberType = msg.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{gameType: gameType, numberType: numberType}),
				...
				default:
					var key = msg.a;
					if (key === ' ') {
						var $temp$msg = author$project$Main$NextMsg,
							$temp$model = model;
						msg = $temp$msg;
						model = $temp$model;
						continue update;
...
var author$project$Main$JargNimetav = {$: 'JargNimetav'};
var author$project$Main$Nimetamine = {$: 'Nimetamine'};
var author$project$Main$PohiNimetav = {$: 'PohiNimetav'};
var author$project$Main$SetupGameMsg = F2(
	function (a, b) {
		return {$: 'SetupGameMsg', a: a, b: b};
	});
							...
							[
								...
								_List_fromArray(
									[
										...
										A2(author$project$Main$SetupGameMsg, author$project$Main$Kuulamine, author$project$Main$PohiNimetav))
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Põhiarvsõnad kuulamine (nimetav)')
									])),
								A2(
								rundis$elm_bootstrap$Bootstrap$Navbar$dropdownItem,
								_List_fromArray(
									[
										elm$html$Html$Attributes$href('#'),
										elm$html$Html$Events$onClick(
										A2(author$project$Main$SetupGameMsg, author$project$Main$Kuulamine, author$project$Main$JargNimetav))
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Järgarvsõnad kuulamine (nimetav)')
									])),
								A2(
								rundis$elm_bootstrap$Bootstrap$Navbar$dropdownItem,
								_List_fromArray(
									[
										elm$html$Html$Attributes$href('#'),
										elm$html$Html$Events$onClick(
										A2(author$project$Main$SetupGameMsg, author$project$Main$Kuulamine, author$project$Main$JargAlalutlev))
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Järgarvsõnad kuulamine (alalütlev)')
									])),
								A2(
								rundis$elm_bootstrap$Bootstrap$Navbar$dropdownItem,
								_List_fromArray(
									[
										elm$html$Html$Attributes$href('#'),
										elm$html$Html$Events$onClick(
										A2(author$project$Main$SetupGameMsg, author$project$Main$Nimetamine, author$project$Main$PohiNimetav))
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Põhiarvsõnad nimetamine (nimetav)')
									])),
								A2(
								rundis$elm_bootstrap$Bootstrap$Navbar$dropdownItem,
								_List_fromArray(
									[
										elm$html$Html$Attributes$href('#'),
										elm$html$Html$Events$onClick(
										A2(author$project$Main$SetupGameMsg, author$project$Main$Nimetamine, author$project$Main$JargNimetav))
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Järgarvsõnad nimetamine (nimetav)')
									])),
								A2(
								rundis$elm_bootstrap$Bootstrap$Navbar$dropdownItem,
								_List_fromArray(
									[
										elm$html$Html$Attributes$href('#'),
										elm$html$Html$Events$onClick(
										A2(author$project$Main$SetupGameMsg, author$project$Main$Nimetamine, author$project$Main$JargAlalutlev))
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Järgarvsõnad nimetamine (alalütlev)')
									]))
							]),
						toggle: A2(
...
var author$project$Main$actionButton = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Button$button,
		_List_fromArray(
			[
				rundis$elm_bootstrap$Bootstrap$Button$primary,
				rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Main$NextMsg)
			]),
		_List_fromArray(
			[
				elm$html$Html$text(
				_Utils_eq(model.state, author$project$Main$Answer) ? 'Next' : 'Answer')
			]));
};
var author$project$Main$getQuizNumber = function (model) {
	var _n0 = model.numberType;
	switch (_n0.$) {
		case 'PohiNimetav':
			return model.quiz.pohiNimetav;
		case 'JargNimetav':
			return model.quiz.jargNimetav;
		default:
			return model.quiz.jargAlalutlev;
	}
};
	...
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2(
						'invisible',
						(!model.loaded) || (_Utils_eq(model.state, author$project$Main$Question) && _Utils_eq(model.gameType, author$project$Main$Kuulamine))),
		...
		_List_fromArray(
			[
				elm$html$Html$text(
				function () {
					var _n0 = _Utils_Tuple2(model.gameType, model.state);
					if (_n0.a.$ === 'Kuulamine') {
						var _n1 = _n0.a;
						return elm$core$String$fromInt(model.quiz.n);
					} else {
						if (_n0.b.$ === 'Question') {
							var _n2 = _n0.a;
							var _n3 = _n0.b;
							...
							var _n4 = _n0.a;
							var _n5 = _n0.b;
							return author$project$Main$getQuizNumber(model);
						}
					}
				}())
			]));
...
var author$project$Main$mp3url = function (n) {
	return (n === '') ? '' : ('media/' + (n + '.mp3'));
};
var author$project$Main$none = elm$html$Html$text('');
	...
	var audioEl = A2(
		...
		_List_fromArray(
			[
				...
				author$project$Main$mp3url(
					author$project$Main$getQuizNumber(model))),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Main$showAnswer(model),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						author$project$Main$actionButton(model)
					]))
			]));
};
